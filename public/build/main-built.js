...
define('text!templates/home.html',[],function () { return '<div class="container">\r\n  <h1>Permission Management</h1>\r\n  <p>\r\n        <ul class="list-group">\r\n          <li class="listuser-menu list-group-item"><a href="#/users">Users</a></li>\r\n          <li class="listperm-menu list-group-item"><a href="#/perms">Permissions</a></li>\r\n          <li class="listrole-menu list-group-item"><a href="#/roles">Roles</a></li>\r\n          <li class="login-menu list-group-item"><a id="login" href="#/login">Login</a></li>\r\n        </ul>  \r\n  </p>\r\n\r\n</div>\r\n\r\n\r\n';});
...
define('text!templates/header.html',[],function () { return '<nav class="navbar navbar-fixed-top navbar-inverse">\n  <div class="container">\n        <div class="navbar-header">\n          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">\n            <span class="sr-only">Toggle navigation</span>\n            <span class="icon-bar"></span>\n            <span class="icon-bar"></span>\n            <span class="icon-bar"></span>\n          </button>\n          <a class="navbar-brand" href="#">Permission management</a>\n        </div>\n        <div id="navbar" class="collapse navbar-collapse">\n          <ul class="nav navbar-nav">\n            <li class="home-menu"><a href="#/home">Home</a></li>\n            <li class="listuser-menu"><a href="#/users">Users</a></li>\n            <li class="listperm-menu"><a href="#/perms">Permissions</a></li>\n            <li class="listrole-menu"><a href="#/roles">Roles</a></li>\n            <li class="login-menu"><a id="login" href="#/login">Login</a></li>\n          </ul>\n          <img class="ajax-loader" src="img/ajax-loader.gif" alt="Loading..." />\n        </div><!--/.nav-collapse -->\n      </div>\n</nav>\n';});
...
define('text!templates/login.html',[],function () { return '<div class="row">\n  <div class="span12">\n\n    <div class="page-header">\n      <h1>Sign in</h1>\n    </div>\n\n    <div id="login">\n        <form>\n            <div class="alerts"></div>\n            <div class="form-group">\n                <label>Username:</label>\n                <input type="text" name="username" id="login-username-input" class="form-control">\n                <span class="help-block"></span>\n            </div>\n            <div class="form-group">\n                <label>Password:</label>\n                <input type="password" name="password" id="login-password-input" class="form-control">\n                <span class="help-block"></span>\n            </div>\n            <div class="form-actions">\n                <a class="btn" id="login-btn">Sign In</a>\n            </div>\n        </form>\n    </div>\n\n  </div>\n</div>\n';});

define('text!templates/userinfo.html',[],function () { return '<div class="row">\n  <div class="span12">\n\n    <div class="page-header">\n      <h1>Sign in</h1>\n    </div>\n\n    <div id="login">\n            <div class="alerts"></div>\n            <div class="form-group">\n                <label>Username:</label>\n                <%=user.username%>\n                <span class="help-block"></span>\n            </div>\n            <div class="form-group">\n                <label>Email:</label>\n                <%=user.email%>\n                <span class="help-block"></span>\n            </div>\n    </div>\n\n  </div>\n</div>\n';});
...
define('text!templates/users/index.html',[],function () { return '<div class="row">\r\n  <div class="span12">\r\n\r\n    <div class="page-header">\r\n      <h1>List of users</h1>\r\n      <a href="#/users/new" class="btn edit-btn">Add User</a>\r\n    </div>\r\n\r\n    <p>\r\n      <table class="table">\r\n        <thead>\r\n          <tr>\r\n            <th><i class="icon-user"></i>Username</th>\r\n            <th><i class="icon-envelope"></i>Email</th>\r\n            <th><i class="icon-time"></i>Last login</th>\r\n          </tr>\r\n        </thead>\r\n        <tbody>\r\n        <% _.each(users, function(user) { %>\r\n          <tr>\r\n            <td>\r\n              <a href="#/users/<%- user._id %>"><%- user.username %></a>\r\n            </td>\r\n            <td>\r\n              <a href="mailto:<%- user.email %>"><%- user.email %></a>\r\n            </td>\r\n            <td>\r\n              <%= moment(new Date(user.lastlogin)).format("MMMM Do YYYY") %>\r\n            </td>\r\n          </tr>\r\n        <% }); %>\r\n        </tbody>\r\n      </table>\r\n    </p>\r\n\r\n  </div>\r\n</div>\r\n';});
...
define('text!templates/users/show.html',[],function () { return '<div class="row">\r\n  <div class="span6">\r\n\r\n    <div class="page-header">\r\n      <h1><%= user.username %></h1>\r\n    </div>\r\n\r\n    <p>\r\n      <table class="table table-striped">\r\n        <tbody>\r\n          <tr>\r\n            <td><h6>Username:</h6></td>\r\n            <td>\r\n              <i class="icon-user"></i>\r\n              <%= user.username %>\r\n            </td>\r\n          </tr>\r\n          <tr>\r\n            <td><h6>Email:</h6></td>\r\n            <td>\r\n              <i class="icon-envelope"></i>\r\n              <a href="mailto:<%= user.email %>"><%= user.email %></a>\r\n            </td>\r\n          </tr>\r\n          <tr>\r\n            <td><h6>Roles:</h6></td>\r\n            <td>\r\n              <i class="icon-briefcase"></i>\r\n              <% _.each(user.roles, function(role) { %>\r\n                <%if (role.allow) {%>\r\n                    <%= role.name %><br>\r\n                <%}%>\r\n              <% }); %>\r\n            </td>\r\n          </tr>\r\n          <tr>\r\n            <td><h6>Permissions:</h6></td>\r\n            <td>\r\n              <i class="icon-time"></i>\r\n            </td>\r\n          </tr>\r\n        </tbody>\r\n      </table>\r\n    </p>\r\n\r\n    <p>\r\n      <a href="#/users/<%= user._id %>/edit" class="btn edit-btn">Edit</a>\r\n      <button class="btn delete-btn">Delete</button>\r\n    </p>\r\n\r\n  </div>\r\n</div>\r\n';});
...
define('text!templates/users/edit.html',[],function () { return '<div class="row">\r\n  <div class="span8">\r\n\r\n    <div class="page-header">\r\n      <h1>Edit User</h1>\r\n    </div>\r\n\r\n    <form class="form-horizontal">\r\n      <fieldset>\r\n\r\n        <div class="control-group">\r\n          <label for="name-input" class="control-label">Name</label>\r\n          <div class="controls">\r\n            <div class="input-prepend">\r\n              <span class="add-on">\r\n                <i class="icon-user"></i>\r\n              </span>\r\n              <%if (user.username){%><%=user.username%><%} else{%>\r\n              <input type=\'text\' class=\'input-xlarge\' id=\'username-input\'/>\r\n              <%}%>\r\n            </div>\r\n          </div>\r\n        </div>\r\n\r\n        <div class="control-group">\r\n          <label for="email-input" class="control-label">Email</label>\r\n          <div class="controls">\r\n            <div class="input-prepend">\r\n              <span class="add-on">\r\n                <i class="icon-envelope"></i>\r\n              </span>\r\n              <input type="text" class="input-xlarge" id="email-input" value="<%= user.email %>" />\r\n              <p class="help-block">Enter a valid email above.</p>\r\n            </div>\r\n          </div>\r\n        </div>\r\n\r\n        <div class="control-group">\r\n          <label for="company-input" class="control-label">Roles</label>\r\n          <div class="controls" id="roles-div">\r\n            <div class="input-prepend">\r\n              <span class="add-on">\r\n                <i class="icon-briefcase"></i>\r\n              </span>\r\n              <div class=\'table-responsive\'>\r\n              <table class="table table-striped">\r\n              <% _.each(user.roles, function(role) { %>\r\n                <tr><td>\r\n                <%= role.name%><td>Member <input type="radio" name="<%=role._id%>" value="allow" <%if(role.allow){%> checked<%}%>><td>Not Member <input type="radio" name="<%=role._id%>" value="deny" <%if(!role.allow){%> checked<%}%>> </tr>\r\n              <% }); %>\r\n              </table>\r\n              </div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n\r\n        <div class="control-group">\r\n          <label for="born-input" class="control-label">Permissions</label>\r\n          <div class="controls" id="perms-div">\r\n            <div class="input-prepend">\r\n              <span class="add-on">\r\n                <i class="icon-time"></i>\r\n              </span>\r\n              <div class=\'table-responsive\'>\r\n              <table class=\'table table-striped\'>\r\n              <% _.each(user.perms, function(perm) { %>\r\n                <tr><td>\r\n                <%= perm.name%>\r\n                <td>Allow <input type="radio" name="<%=perm._id%>" value="allow" <%if(perm.allow){%> checked<%}%>>\r\n                <td>Deny <input type="radio" name="<%=perm._id%>" value="deny" <%if(perm.deny){%> checked<%}%>> \r\n                <td align=\'right\'>Inherit<%if(perm.inherit_allow) {%>(allow)<%} else if(perm.inherit_deny) {%>(deny)<%}%>\r\n                    <input type="radio" name="<%=perm._id%>" value="inherit" <%if (perm.inherit_allow || perm.inherit_deny){%> checked<%}%>>\r\n                </tr>\r\n              <% }); %>\r\n              </table>\r\n              </div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n\r\n        <div class="form-actions">\r\n          <a class="btn save-btn">Save</a>\r\n          <a class="btn back-btn">Back</a>\r\n        </div>\r\n\r\n      </fieldset>\r\n    </form>\r\n\r\n  </div>\r\n</div>\r\n';});
...
define('text!templates/perms/index.html',[],function () { return '<div class="row">\r\n  <div class="span12">\r\n\r\n    <div class="page-header">\r\n      <h1>List of permissions</h1><br>\r\n      <a href="#/perms/new" class="btn edit-btn">Add Permission</a>\r\n    </div>\r\n\r\n    <p>\r\n      <table class="table">\r\n        <thead>\r\n          <tr>\r\n            <th><i class="icon-user"></i>Name</th>\r\n            <th><i class="icon-envelope"></i>Key</th>\r\n          </tr>\r\n        </thead>\r\n        <tbody>\r\n        <% _.each(perms, function(perm) { %>\r\n          <tr>\r\n            <td>\r\n              <a href="#/perms/<%- perm._id %>"><%- perm.name %></a>\r\n            </td>\r\n            <td>\r\n              <%- perm.key %>\r\n            </td>\r\n          </tr>\r\n        <% }); %>\r\n        </tbody>\r\n      </table>\r\n    </p>\r\n\r\n  </div>\r\n</div>\r\n';});
...
define('text!templates/perms/show.html',[],function () { return '<div class="row">\r\n  <div class="span6">\r\n\r\n    <div class="page-header">\r\n      <h1>Permission</h1>\r\n    </div>\r\n\r\n    <p>\r\n      <table class="table table-striped">\r\n        <tbody>\r\n          <tr>\r\n            <td><h6>name:</h6></td>\r\n            <td>\r\n              <i class="icon-user"></i>\r\n              <%= perm.name %>\r\n            </td>\r\n          </tr>\r\n          <tr>\r\n            <td><h6>Key:</h6></td>\r\n            <td>\r\n              <i class="icon-envelope"></i>\r\n              <%= perm.key%>\r\n            </td>\r\n          </tr>\r\n        </tbody>\r\n      </table>\r\n    </p>\r\n\r\n    <p>\r\n      <a href="#/perms/<%= perm._id %>/edit" class="btn edit-btn">Edit</a>\r\n      <button class="btn delete-btn">Delete</button>\r\n    </p>\r\n\r\n  </div>\r\n</div>\r\n';});
...
define('text!templates/perms/edit.html',[],function () { return '<div class="row">\r\n  <div class="span8">\r\n\r\n    <div class="page-header">\r\n      <h1>Edit Permission</h1>\r\n    </div>\r\n\r\n    <form class="form-horizontal">\r\n      <fieldset>\r\n\r\n        <div class="control-group">\r\n          <label for="name-input" class="control-label">Name</label>\r\n          <div class="controls">\r\n            <div class="input-prepend">\r\n              <span class="add-on">\r\n                <i class="icon-user"></i>\r\n              </span>\r\n             <input type="text" class="input-xlarge" id="name-input" value="<%= perm.name %>" />\r\n            </div>\r\n          </div>\r\n        </div>\r\n\r\n        <div class="control-group">\r\n          <label for="email-input" class="control-label">Key</label>\r\n          <div class="controls">\r\n            <div class="input-prepend">\r\n              <span class="add-on">\r\n                <i class="icon-envelope"></i>\r\n              </span>\r\n              <input type="text" class="input-xlarge" id="key-input" value="<%= perm.key %>" />\r\n              <p class="help-block">Enter a valid email above.</p>\r\n            </div>\r\n          </div>\r\n        </div>\r\n\r\n        <div class="form-actions">\r\n          <a class="btn save-btn">Save</a>\r\n          <a class="btn back-btn">Back</a>\r\n        </div>\r\n\r\n      </fieldset>\r\n    </form>\r\n\r\n  </div>\r\n</div>\r\n';});
...
define('text!templates/roles/index.html',[],function () { return '<div class="row">\r\n  <div class="span12">\r\n\r\n    <div class="page-header">\r\n      <h1>List of roles</h1><br>\r\n      <a href="#/roles/new" class="btn edit-btn">Add Role</a>\r\n    </div>\r\n\r\n    <p>\r\n      <table class="table">\r\n        <thead>\r\n          <tr>\r\n            <th><i class="icon-user"></i>Name</th>\r\n            <th><i class="icon-envelope"></i>Permissions</th>\r\n          </tr>\r\n        </thead>\r\n        <tbody>\r\n        <% _.each(roles, function(role) { %>\r\n          <tr>\r\n            <td>\r\n              <a href="#/roles/<%- role._id %>"><%- role.name %></a>\r\n            </td>\r\n            <td>\r\n                <!--permissions-->\r\n            </td>\r\n          </tr>\r\n        <% }); %>\r\n        </tbody>\r\n      </table>\r\n    </p>\r\n\r\n  </div>\r\n</div>\r\n';});
...
define('text!templates/roles/show.html',[],function () { return '<div class="row">\r\n  <div class="span6">\r\n\r\n    <div class="page-header">\r\n      <h1>Role</h1>\r\n    </div>\r\n\r\n    <p>\r\n      <table class="table table-striped">\r\n        <tbody>\r\n          <tr>\r\n            <td><h6>name:</h6></td>\r\n            <td>\r\n              <i class="icon-user"></i>\r\n              <%= role.name %>\r\n            </td>\r\n          </tr>\r\n          <tr>\r\n            <td><h6>Permissions:</h6></td>\r\n            <td>\r\n              <i class="icon-envelope"></i>\r\n              <% _.each(role.perms, function(perm) { %>\r\n                <% if (perm.allow) {%><%=perm.name%><br>\r\n                <% }%>\r\n              <% }); %>\r\n            </td>\r\n          </tr>\r\n        </tbody>\r\n      </table>\r\n    </p>\r\n\r\n    <p>\r\n      <a href="#/roles/<%= role._id %>/edit" class="btn edit-btn">Edit</a>\r\n      <button class="btn delete-btn">Delete</button>\r\n    </p>\r\n\r\n  </div>\r\n</div>\r\n';});
...
define('text!templates/roles/edit.html',[],function () { return '<div class="row">\r\n  <div class="span8">\r\n\r\n    <div class="page-header">\r\n      <h1>Edit Role</h1>\r\n    </div>\r\n\r\n    <form class="form-horizontal">\r\n      <fieldset>\r\n\r\n        <div class="control-group">\r\n          <label for="name-input" class="control-label">Name</label>\r\n          <div class="controls">\r\n            <div class="input-prepend">\r\n              <span class="add-on">\r\n                <i class="icon-user"></i>\r\n              </span>\r\n             <input type="text" class="input-xlarge" id="name-input" value="<%= role.name %>" />\r\n            </div>\r\n          </div>\r\n        </div>\r\n\r\n        <div class="control-group">\r\n          <label for="email-input" class="control-label">Permissions</label>\r\n          <div class="controls">\r\n            <div class="input-prepend">\r\n              <!--span class="add-on">\r\n                <i class="icon-envelope"></i>\r\n              </span-->\r\n              <table class="input-xlarge">\r\n              <% _.each(role.perms, function(perm) { %>\r\n                <tr><td>\r\n                <%= perm.name%><td>Allow <input type="radio" name="<%=perm._id%>" value="allow" <%if(perm.allow){%> checked<%}%>><td>Deny <input type="radio" name="<%=perm._id%>" value="deny" <%if(!perm.allow){%> checked<%}%>> </tr>\r\n              <% }); %>\r\n              </table>\r\n            </div>\r\n          </div>\r\n        </div>\r\n\r\n        <div class="form-actions">\r\n          <a class="btn save-btn">Save</a>\r\n          <a class="btn back-btn">Back</a>\r\n        </div>\r\n\r\n      </fieldset>\r\n    </form>\r\n\r\n  </div>\r\n</div>\r\n';});
