...
RolesController = function(app, mongoose, config) {
    ...
    app.get(app.v1 + '/roles', app.ensureAuthenticated, function index(req, res, next) {
    ...
    app.get(app.v1 + '/roles/:id', app.ensureAuthenticated, function show(req, res, next) {
    ...
    app.del(app.v1 + '/roles/:id', app.ensureAuthenticated, function destroy(req, res, next) {
    ...
    app.put(app.v1 + '/roles/:id', app.ensureAuthenticated, function update(req, res, next) {
        Role.findById(req.params.id, false /* details */, function(err, role) {
            checkErr(
                next,
                [{ cond: err }, { cond: !role, err: new NotFound('json') }],
    ...
    app.post(app.v1 + '/roles', app.ensureAuthenticated, function create(req, res, next) {
